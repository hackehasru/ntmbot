...
client.on("guildMemberAdd", message => {
  client.channels.get("960276379054792734").setName(`🔵 Kişi Sayısı: ${message.guild.memberCount} 📤`);
...
client.on("guildMemberRemove", message => {
  client.channels.get("960276735071506462").setName(`🔴 Kişi Sayısı: ${message.guild.memberCount} 📥`);
